package com.yang.areaservice.controller;
...
import com.yang.areaservice.service.GeoService;
...
public class AreaController {
    ...
    public ResponseEntity<Mono<String>> findAreaNameByLocation(@PathVariable("coordinate") 
    	String coordinate) {
